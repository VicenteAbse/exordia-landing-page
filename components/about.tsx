      ...
      <div className="mx-auto max-w-7xl px-6 pt-10">
        <div className="grid gap-16 lg:items-center">
          <div className="mx-auto">
            ...
            <p className="mt-6 font-serif leading-relaxed text-muted-foreground mx-auto text-justify">
            ...
            <p className="mt-4 font-serif leading-relaxed text-muted-foreground text-justify">
